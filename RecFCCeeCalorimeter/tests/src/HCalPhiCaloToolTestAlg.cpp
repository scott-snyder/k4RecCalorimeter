...
private:
  ...
  Gaudi::Property<int> m_expectedBarrelCells
  { this, "ExpectedBarrelCells", 0, "" };
  Gaudi::Property<int> m_expectedEndcapCells
  { this, "ExpectedEndcapCells", 0, "" };

  Gaudi::Property<std::string> m_expectedBarrelReadout
  { this, "ExpectedBarrelReadout", "", "" };
  Gaudi::Property<std::string> m_expectedEndcapReadout
  { this, "ExpectedEndcapReadout", "", "" };
...
StatusCode HCalPhiCaloToolTestAlg::initialize()
{
  if (m_groupRows) {
    ...
    auto* seg =
      dynamic_cast<dd4hep::DDSegmentation::FCCSWHCalPhiRow_k4geo*> (readout.segmentation().segmentation());
    if (!seg) {
...
StatusCode HCalPhiCaloToolTestAlg::testTool (const k4::recCalo::ICalorimeterTool& tool,
...
StatusCode HCalPhiCaloToolTestAlg::execute()
{
  return StatusCode::SUCCESS;
}
