...
detectors_to_use = ["FCChh_DectMaster.xml"]
...
calibEcalBarrel = CalibrateInLayersTool(
    ...
    samplingFraction=[0.36571381189697705] * 1
...
createEcalBarrelCellsStep1 = CreateCaloCells(
...
mergelayersEcalFwd = MergeLayers(
    "MergeLayersEcalFwd",
    # take the bitfield description from the geometry service
...
createEcalFwdCells = CreateCaloCells(
    "CreateEcalFwdCaloCells",
    doCellCalibration=True,
...
createHcalCells = CreateCaloCells(
    "CreateHCaloCells",
    doCellCalibration=True,
...
createExtHcalCells = CreateCaloCells(
    "CreateExtHcalCaloCells",
    doCellCalibration=True,
    calibTool=calibHcells,
    addCellNoise=False,
    filterCellNoise=False,
...
mergelayersHcalEndcap = MergeLayers(
...
createHcalEndcapCells = CreateCaloCells(
    "CreateHcalEndcapCaloCells",
    doCellCalibration=True,
...
mergelayersHcalFwd = MergeLayers(
    "MergeLayersHcalFwd",
    # take the bitfield description from the geometry service
...
createHcalFwdCells = CreateCaloCells(
    "CreateHcalFwdCaloCells",
    doCellCalibration=True,
