...
HCalBcells = CellPositionsHCalBarrelTool(
...
from Configurables import (
    CreateFCChhCaloNoiseLevelMap,
    ConstNoiseTool,
    ReadNoiseFromFileTool,
)

ECalNoiseTool = ReadNoiseFromFileTool(
    "ReadNoiseFromFileToolECal",
...
HCalNoiseTool = ReadNoiseFromFileTool(
    "ReadNoiseFromFileToolHCal",
    readoutName=hcalBarrelReadoutName,
...
noisePerCell = CreateFCChhCaloNoiseLevelMap(
    "noisePerCell",
