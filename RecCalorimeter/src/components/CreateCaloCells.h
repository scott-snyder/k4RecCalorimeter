...
private:
  ...
  ToolHandle<k4::recCalo::INoiseCaloCellsTool> m_noiseTool{"NoiseCaloCellsFlatTool", this};
  /// Handle for the geometry tool
  ToolHandle<k4::recCalo::ICalorimeterTool> m_geoTool
    { this, "geometryTool", "", };
  ToolHandle<k4::recCalo::ICellPositionsTool> m_cellPos
