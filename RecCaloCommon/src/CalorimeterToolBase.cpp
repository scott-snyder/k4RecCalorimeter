 ...
 */
auto CalorimeterToolBase::cellIDs() const -> const std::vector<CellID>& { return *m_cells; }
 ...
 */
const dd4hep::DDSegmentation::Segmentation* CalorimeterToolBase::segmentation() const {
  if (m_readout.isValid()) {
 ...
 */
const std::string& CalorimeterToolBase::readoutName() const { return m_readoutName; }
